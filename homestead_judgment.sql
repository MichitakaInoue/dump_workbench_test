...
CREATE TABLE `judgment` (
  ...
  `judges_id` bigint(20) unsigned NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `judgment_judges_id_foreign` (`judges_id`),
  CONSTRAINT `judgment_judges_id_foreign` FOREIGN KEY (`judges_id`) REFERENCES `judges` (`id`)
...
-- Dump completed on 2019-08-25 21:37:20
